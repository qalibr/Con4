...
const Multiplayer = () => {
  ...
  // When two players are in the same row/entry
  ...
  useEffect(() => {
    ...
    debugState("End: useEffect(2)");

    return () => {
      matchChannel.unsubscribe();
    };
  }, [user, isQueued, moveNumber, gameStatus]);
